Feature: Tags
  ...
  Scenario: user attempts to create a tag with only numbers in its description
    ...
    And user fills tag name, color and description
      | tag-name           | tag-color | description                                                       |
      | conjugar-dimicular | 000000    | 62783923768906278392376890627839237689062783923768906278392376890 |
  ...
  Scenario: user deletes tags created in three different scenarios
    ...
    When deleting these tags
      ...
      | four-tags-test-03  | Some good description for four-tags-test-03                       |
      | four-tags-test-04  | Some good description for four-tags-test-04                       |
      | conjugar-dimicular | 62783923768906278392376890627839237689062783923768906278392376890 |
    Then those tags should not be displayed in the tags page
  ...
  Scenario: user attempts to create a tag with 5 characters in the HEX code

    When user clicks on new tag
    And user fills tag name, color and description
      | tag-name          | tag-color | description |
      | something random? | FF861     | invalid     |
    But tag is not saved


  Scenario: user attempts to create a tag with 500 characters in its name

    When user clicks on new tag
    And user fills tag name, color and description
      | tag-name                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | tag-color | description        |
      | Dor si amet Lorem ipsum dolor si amet Lorem ipsum dolor si amet Lorem ipsum dolor si amet Lorem ipsum dolor si ametLorem ipsum dolor si amet Lorem ipsum dolor si amet Lorem ipsum dolor si ametLorem ipsum dolor si amet Lorem ipsum dolor si amet Lorem ipsum dolor si ametLorem ipsum dolor si amet Lorem ipsum dolor si amet Lorem ipsum dolor si ametLorem ipsum dolor si amet Lorem ipsum dolor si amet Lorem ipsum dolor si ametLorem ipsum dolor si amet Lorem ipsum dolor si amet Lorem ipsum dolor si amet | 000000    | Beautiful Onyx tag |
    But tag is not saved


  Scenario: user fills the color field with 6 special characters
